...
public class TxOffsetCommit {

    static String CONSUMER_GROUP_ID = "siemens-tx-cg";
    static String TX_ID = "siemens-tx";

    public static void main(String[] args) throws IOException, InterruptedException {
        if (args == null || args.length < 3) {            
            System.out.println("TxOffsetCommit <path/to/properties> <inputTopi> <outputTopi>");
            System.exit(1);
        }
        System.out.println("*** Running TxOffsetCommit ***");
            ...
            try {
                while (true) {
                    ...
                    while (recordsIterator.hasNext()) {
                        ...
                        producer.sendOffsetsToTransaction(offsetData, CONSUMER_GROUP_ID);
                ...
                //Do we have data already processed
